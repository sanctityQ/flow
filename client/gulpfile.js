...
gulp.task('copyFont', ['react'], function() {
    // 拷贝iconfont文件
    gulp.src('client/src/vendor/bower_components/font-awesome/fonts/*.{ttf,woff,eot,svg,woff2}')
        .pipe(gulp.dest('client/build/client/src/vendor/bower_components/font-awesome/fonts/'));
});
